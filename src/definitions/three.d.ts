// Type definitions for three.js r76
...
declare namespace THREE {
   ...
   // custom blending src factors
    ...
    export class TextureLoader {
         ...
         * @param url
         */
        load(url: string, onLoad?: (texture: Texture) => void, onProgress?: Function, onError?: Function): Texture;
        setCrossOrigin(crossOrigin: string): void;
        setPath(path: string): void;
    }
    ...
    export class AudioLoader{
        constuctor(manager?: LoadingManager);
